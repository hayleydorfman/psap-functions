...
setwd("/Users/hayleydorfman/Dropbox (Harvard SNP Lab)/PSAP ITC/Code/Final Code/PROV/")
...
setwd("/Users/hayleydorfman/Dropbox (Harvard SNP Lab)/PSAP ITC/Code/Final Code/PROV/Output")
write.csv(mainDat, file = paste(c("aggPROC_model_summary", ".csv"), collapse = ""))
