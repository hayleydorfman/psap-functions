...
df <- read.csv("1agg_PROA_model_fit.csv")
...
df2 <- read.csv("2agg_PROA_model_fit.csv")
...
df3 <- read.csv("3agg_PROA_model_fit.csv")
...
df4 <- read.csv("4agg_PROA_model_fit.csv")
...
df5 <- read.csv("5agg_PROA_model_fit.csv")
...
df6 <- read.csv("6agg_PROA_model_fit.csv")
...
df7 <- read.csv("7agg_PROA_model_fit.csv")
...
df8 <- read.csv("8agg_PROA_model_fit.csv")
...
df9 <- read.csv("9agg_PROA_model_fit.csv")
...
df10 <- read.csv("10agg_PROA_model_fit.csv")
...
df11 <- read.csv("11agg_PROA_model_fit.csv")
...
df12 <- read.csv("12agg_PROA_model_fit.csv")
...
df13 <- read.csv("13agg_PROA_model_fit.csv")
...
df14 <- read.csv("14agg_PROA_model_fit.csv")
...
df15 <- read.csv("15agg_PROA_model_fit.csv")
...
df16 <- read.csv("16agg_PROA_model_fit.csv")
...
df17 <- read.csv("17agg_PROA_model_fit.csv")
...
df18 <- read.csv("18agg_PROA_model_fit.csv")
...
df19 <- read.csv("19agg_PROA_model_fit.csv")
...
df20 <- read.csv("20agg_PROA_model_fit.csv")
...
df21 <- read.csv("21agg_PROA_model_fit.csv")
